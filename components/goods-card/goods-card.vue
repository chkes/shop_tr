<template>
	<navigator class="goods_item" :url="'/subpkg/goods_detail/goods_detail?id=' + goods.id">
		...
		<view class="p-b u-flex u-row-between ">
			<view class="price u-skeleton-rect">$ {{goods.price ? goods.price : '60'}}</view>
			<view class="buypeopel u-skeleton-rect">{{goods.sales}} 人付款</view>
		</view>
	</navigator>
